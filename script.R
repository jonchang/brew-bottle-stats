...
p1 <- ggplot(df2, aes(date, value, lty = key)) + geom_line() + labs(x = "Date", y = "Count") + scale_y_continuous(limits = c(0, 5100), expand = c(0, 0)) + scale_x_continuous(expand = c(0,0)) + theme_cowplot() + theme(legend.position = "none")
